...
### マップチップ
マップチップを並べてマップをつくることができます。くわしくは [マップチップ](/ghide/tiled/) を参照してください。

### 背景
背景はほかのパーツと違い、キャラクター移動時のスクロール量を調整できるので、かんたんに遠景を表現できます。くわしくは、[背景](#背景の設定)を参照してください。
...
::: tip おしらせ
この機能は実験的に公開しています。もろもろ不具合があるかもしれません。
:::
